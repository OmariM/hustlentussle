...
class PairingRulesTestSuite(unittest.TestCase):
    ...
    def test_initial_pairing_validity(self):
        ...
        # Check no duplicates
        all_competing = [game.pair_1[0].name, game.pair_1[1].name, game.pair_2[0].name, game.pair_2[1].name]
    ...
    def test_winner_queue_management(self):
        ...
        queue_leads = {c.name for c in game.leads}
        self.assertTrue(
            target_lead.name in queue_leads or (game.winning_lead and game.winning_lead.name == target_lead.name)
        )
    ...
    def test_pairing_avoids_recent_winners(self):
        ...
        new_pairs = [(game.pair_1[0].name, game.pair_1[1].name), (game.pair_2[0].name, game.pair_2[1].name)]
