...
class TestSuiteRunner:
    ...
    def generate_report(self) -> str:
        ...
        overall_success_rate = ((self.total_tests - self.total_failures - self.total_errors) / max(1, self.total_tests)) * 100
        ...
        for suite_name, result in self.results.items():
            ...
            report.append(f"{status} {suite_name}: {result['success_rate']:.1f}% "
